shared_examples "Short Views: Delete Test Departments" do
  it "Delete departments and building" do
  end
  ...
  it "Delete them all" do
    ...
    $browser.find_element(:link_text, "Department A").click
    ...
    $browser.find_element(:link_text, "Academic Department").click
    expect($browser.title).to eq("Academic Department")
    $browser.find_element(:link_text, "Department B").click
