shared_examples "Create Accounts: Delete New Self Editor User" do
  it "Delete new Editor account" do
  end
  ...
  it "Delete the account" do
    ...
    expect($browser.find_elements(:link_text, "RickRookie@mydomain.edu").size).to eq(0)
  end
