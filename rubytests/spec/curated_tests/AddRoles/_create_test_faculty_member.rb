shared_examples "Add Roles: Create Test Faculty Member" do
  ...
  it "rebuild the search index in case any crud left from previous tests" do
    $browser.navigate.to vivo_url("/SearchIndex")
